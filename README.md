...
> tomatobang 官网,之前想着基于 strikingly.com 开发也不错,但是自己毕竟是程序员嘛,折腾下也不错.
#### [tomato-web](https://github.com/tomatobang/tomato-web), dev based on koa2 & angular2  
> tomatobang WEB 端, 第一版开发主要集中在 Web 端开发,理清业务,确定开发流程.
#### [tomato-server](https://github.com/tomatobang/tomato-server)
> tomatobang 服务端, 集成 mongo 与 redis,事实上也没用到其的一些高级功能,一些待发掘.
#### [tomato-android](https://github.com/tomatobang/tomato-android)
> tomatobang Android 客户端,总的来说,也算是有点基础,结合视频视频、结合 Github 源代码开发
...
> 支持通过拖拽实现设施控件的绘制，可惜后期取消了在这方面的投入，基本上也就只剩下一个架子在这里了，开发基于阿里的游戏引擎 [hilo](http://hiloteam.github.io/)
#### [a-company-website](https://github.com/pengkobe/a-company-website)
> 帮朋友写的一个官网，基于 YXCms 进行开发，对前台模板进行了定制性的开发，也算是熟悉了一把 PHP 开发的流程，部署在阿里云虚拟主机上面。
#### [node-qrcode-generator](https://github.com/pengkobe/node-qrcode-generator)
> 二维码自动生成工具，基于 node-canvas. 只要有点前端开发基础，基本上能够解决问题
...
> 设施监控控件化，使用到了 OOP 的一些内容，关于接口的封装与公布还是有很多需要改善的地方
#### [dashboard](https://github.com/pengkobe/dashboard)
> 自己做的一些展示页，主要用于公司展台以及内部的一些数据可视化，版权归公司所有
#### [efos-app](https://github.com/pengkobe/efos-app)
> 后续开发已闭源
#### [ess-wechat](https://github.com/pengkobe/ess-wechat)
> 后续开发已闭源，主要基于 wechat api 进行开发，涉及到公众号的一些内容。

## New Field Related
#### [webgl-practice](https://github.com/pengkobe/webgl-practice)
> 记录自己学习 webgl 的一些笔记与 demo，这家伙刚开始学起来比较吃力，后续结合 Three.js 进行开发会好的多，也就在这时候，人生第一次微博中奖，中的书籍是:《Three.js 开发指南》
#### [h5-live-video-demo](https://github.com/pengkobe/h5-live-video-demo)
> 技术做一个直播的 Demo，看了吕小鸣的博客有感而建，最终还是不了了之
...
> 计划基于 webgl 开发一个设施实时监控的示例，后来外包商有现成的解决方案而告终。
#### [nba-news-puller](https://github.com/pengkobe/nba-news-puller)
> 第一次开发 Chrome 插件，其实开发难度不大，主要得熟悉 API。
...
> 记录 ionic1.x 的一些笔记，此 Repo 不会再更新了，内容也迁移到了 Project-notes
